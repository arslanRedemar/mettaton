...
const fs = require('fs');
const { initializeDatabase, closeDatabase } = require('../../../src/infrastructure/persistence/database');
const SqliteRepository = require('../../../src/infrastructure/persistence/SqliteRepository');
...
describe('SqliteRepository', () => {
  ...
  beforeEach(() => {
    ...
    const db = require('../../../src/infrastructure/persistence/database').getDatabase();
