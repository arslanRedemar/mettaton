...
const PARAM_MAP = {
  ...
  // Moon calendar strings
  'messageCreate.moonCommand': [],
  'messageCreate.moonLoading': [],
  'messageCreate.moonTitle': [],
  'messageCreate.moonDescription': [],
  'messageCreate.moonFooter': [],
  'messageCreate.moonError': [],
  'messageCreate.moonErrorLog': [],
  // Schedule controller strings
  'schedule.registerSuccess': [],
  'schedule.registerFail': [],
  'schedule.emptyTitle': [],
  'schedule.emptyLocation': [],
  'schedule.emptyTeacher': [],
  'schedule.invalidDate': [],
  'schedule.invalidStartTime': [],
  'schedule.invalidEndTime': [],
